module github.com/OpenFunction/function-agent
...
replace (
	github.com/OpenFunction/functions-framework-go v0.4.0 => github.com/wrongerror/functions-framework-go v0.0.0-20220916033035-c9e16ace756d
